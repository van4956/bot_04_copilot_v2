...
async def cmd_miniapp(message: types.Message, workflow_data: dict):
    ...
    builder.row(InlineKeyboardButton(text="🎮 Тетрис", web_app=WebAppInfo(url=WEBAPP_URL_PIZZA)))
    builder.row(InlineKeyboardButton(text="🐍 Змейка", web_app=WebAppInfo(url=WEBAPP_URL_PIZZA)))
